...
THEME_TOKENS: Dict[str, ThemeTokens] = {
    "dark": ThemeTokens(
        ...
        values={
            ...
            "radius_medium": "10px",
            "radius_large": "16px",
            "table_row_baseline": "#2c2818",
            "table_row_staged": "#1a2638",
            "text_staged": "#d6ecff",
            "tree_inbound": "#6c7086",
            "tree_memory_item": "#3dd2ff",
        },
    ),
    "light": ThemeTokens(
        name="Aurora Light",
        values={
            ...
            "radius_medium": "10px",
            "radius_large": "16px",
            "table_row_baseline": "#fff8e1",
            "table_row_staged": "#d6ecff",
            "text_staged": "#0b3d60",
            "tree_inbound": "#7f8c8d",
            "tree_memory_item": "#005FB8",
        },
    ),
    "catppuccin": ThemeTokens(
        ...
        values={
            ...
            "radius_medium": "10px",
            "radius_large": "16px",
            "table_row_baseline": "#413e2f",
            "table_row_staged": "#2a324a",
            "text_staged": "#89dceb",
            "tree_inbound": "#6c7086",
            "tree_memory_item": "#8aadf4",
        },
    ),
}
